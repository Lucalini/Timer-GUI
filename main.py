...
def count_down(count):
    ...
    if count > 0:
        ...
        for _ in range(math.gloor(reps/2)):
            mark += "✔"
...
title = Label(text= "Timer", font= ("courier", 40, "bold"), fg="#9bdeac", bg="#f7f5dd" )
...
checkmark = Label(text= mark, font=("courier", 14, "bold"), fg="#9bdeac", bg="#f7f5dd" )
